...
class Weapon(Item):
    ...
    def __init__(self, name, description, image_path, attack_bonus, speed_bonus=0, value=0):
    ...
    def use(self, character):
        """Equip the weapon"""
        print(f"{character.character_name} equipped {self.name} (+{self.attack_bonus} attack, +{self.speed_bonus} speed)")
        character.attack += self.attack_bonus
        character.speed += self.speed_bonus
...
class Armor(Item):
    ...
    def __init__(self, name, description, image_path, defense_bonus, hp_bonus, value=0):
    ...
    def use(self, character):
        """Equip the armor"""
        print(f"{character.character_name} equipped {self.name} (+{self.defense_bonus} defense, +{self.hp_bonus} hp)")
        character.defense += self.defense_bonus
        character.max_hp += self.hp_bonus
        character.hp += self.hp_bonus
...
class Consumable(Item):
    ...
    def use(self, character):
        ...
        if self.effect_type == "heal":
            ...
            character.attack += self.effect_amount
            print(f"{character.character_name}'s attack increased by {self.effect_amount}!")
...
def create_example_items():
    ...
    items.append(Weapon(
        name="Spirit Sword",
        description="A sword infused with condensed spiritual energy.",
        image_path="../../graphics/items/spirit_sword.png",
        attack_bonus=15,
        speed_bonus=2,
        value=150
    ))
    ...
    items.append(Weapon(
        name="Wind Swift Sword",
        description="A lightweight blade that enhances agility.",
        image_path="../../graphics/items/wind_swift_sword.png",
        attack_bonus=10,
        speed_bonus=5,
        value=130
    ))
    ...
    items.append(Weapon(
        name="Spirit Staff",
        description="A staff carved from ancient spirit wood.",
        image_path="../../graphics/items/spirit_staff.png",
        attack_bonus=18,
        speed_bonus=3,
        value=170
    ))
    ...
    items.append(Armor(
        name="Spirit Armor",
        description="Reinforced armor infused with spiritual essence.",
        image_path="../../graphics/items/spirit_armor.png",
        defense_bonus=40,
        hp_bonus=15,
        value=200
    ))
    ...
    items.append(Armor(
        name="Swift Robe",
        description="Light robes favored by agile cultivators.",
        image_path="../../graphics/items/swift_robe.png",
        defense_bonus=10,
        hp_bonus=30,
        value=180
    ))
    ...
    items.append(Consumable(
        name="Healing Pill",
        description="A basic recovery pill refined by beginner alchemists. Restores 50 HP.",
        image_path="../../graphics/items/healing_pill.png",
        effect_type="heal",
        effect_amount=50,
        value=50,
        max_stack=99
    ...
    items.append(Consumable(
        name="Battle Pill",
        description="Temporarily enhances combat ability.",
        image_path="../../graphics/items/battle_pill.png",
        effect_type="attack",
        effect_amount=50,
        value=50,
        max_stack=99
    ...
    items.append(Item(
        ...
        description="Expands inventory capacity",
        image_path="../../graphics/items/spatial_ring.png",
    ))
