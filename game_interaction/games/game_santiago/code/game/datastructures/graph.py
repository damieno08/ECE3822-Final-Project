...
class Graph:
    ...
    def add_edge(self, from_id, to_id, weight=1, edge_data=None):
        ...
        """
        if self.has_node(from_id) == False:
            self.add_node(from_id)
        if self.has_node(to_id) == False:
            self.add_node(to_id)
    ...
    def remove_node(self, node_id):
        ...
        """
        if self.has_node(node_id) == False:
        ...
        for nid in all_nodes:
            if nid != node_id:
                ...
                for nb, w, ed in neighbors:
                    if nb != node_id:
                        new_neighbors.append((nb, w, ed))
                self._adj.set(nid, new_neighbors)
    ...
    def remove_edge(self, from_id, to_id):
        ...
        """
        if self.has_node(from_id) == False or self.has_node(to_id) == False:
        ...
        if self.directed == False:
            reverse_neighbors = self._adj.get(to_id)
            new_reverse = []
            for nb, w, ed in reverse_neighbors:
                if nb != from_id:
                    new_reverse.append((nb, w, ed))
            self._adj.set(to_id, new_reverse)
    ...
    def bfs(self, start_id):
        ...
        """
        if self.has_node(start_id) == False:
    ...
    def shortest_path(self, start_id, end_id):
        ...
        """
        if self.has_node(start_id) == False or self.has_node(end_id) == False:
            raise KeyError((start_id, end_id))
    ...
    def __str__(self):
        ...
        if self.directed:
            return "Graph(directed, nodes=" + str(self._num_nodes) + ")"
        else:
            return "Graph(undirected, nodes=" + str(self._num_nodes) + ")"