...
if __name__ == "__main__":
    from game_interaction.games.Luainid.code.game.item import Weapon, Armor, Consumable
    ...
    # Add items
    print("Adding items...")
    GreatSword = Weapon("GreatSword", "A large two handed sword that serves as the starter weapon for Barbarians and Paladins", "../graphics/item/GreatSword.png", attack_bonus=5, value=100)
    ...
    Staff = Weapon("Staff", "The staff allows the user to cast grand magic. It is also the starting weapon of a Druid.", "../graphics/item/Staff.png", attack_bonus=2, value=40)
