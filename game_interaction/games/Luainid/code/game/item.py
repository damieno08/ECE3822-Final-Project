...
def create_example_items():
    ...
    items.append(Weapon(
        ...
        image_path="../../graphics/items/GreatSword.png",
        attack_bonus=5,
        value=100
    ))
    ...
    items.append(Armor(
        ...
        image_path="../../graphics/items/SpiderSilkShield.png",
        defense_bonus=1,
        value=20
    ))
    items.append(Armor(
        ...
        image_path="../../graphics/items/CloakMoonMaiden.png",
        defense_bonus=1,
        value=50
    ))
    ...
    items.append(Weapon(
        ...
        image_path="../../graphics/items/Longbow.png",
        attack_bonus=3,
        value=70
    ))
    ...
    items.append(Consumable(
        ...
        image_path="../../graphics/items/MoonMaidenShard.png",
    ...
    items.append(QuestItem(
        ...
        image_path="../../graphics/items/SoulStrikeSword.png",
        quest_id="Mycanoid",
    ))
