...
from game_interaction.games.game_paul.code.game.datastructures.stack import Stack
...
class TimeTravel:
    ...
    def record_state(self, player_x, player_y):
        ...
        if self.frames_since_last_record >= self.sample_rate:
            ...
            # Enforce max_history limit (remove oldest)
            ...
            # New timeline invalidates future
            self.future.clear()
            self.frames_since_last_record = 0
