...
from game_interaction.games.game_tom.code.game.support import import_folder
from game_interaction.games.game_tom.code.game.inventory import Inventory
...
class Character(pygame.sprite.Sprite):
    ...
    def import_player_assets(self, animate=True):
        ...
        from game_interaction.games.game_tom.code.game.sprite_loader import SpriteLoader
