...
class Waypoint:
    ...
    def __init__(self, x, y, wait_time=0):
        ...
        """
        # DONE: Store x, y, wait_time
        # DONE: Initialize next pointer to None
        # DONE: Initialize prev pointer to None (needed for doubly linked lists)
    ...
    def distance_to(self, other_x, other_y):
        ...
        """
        # DONE: Calculate and return sqrt((x2-x1)^2 + (y2-y1)^2)
        result = math.sqrt((other_x - self.x)**2 + (other_y - self.y)**2)
