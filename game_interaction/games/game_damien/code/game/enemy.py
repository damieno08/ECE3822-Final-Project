...
ENEMY_SPAWN_DATA = [
    {
        "name": "Forest Guard",
        "spawn": (5, 5), # Inside Area 0 clearing
    ...
    },
    {
        ...
        "spawn": (25, 5), # Area 2 (top right)
        "waypoints": [(21, 5), (28, 5)],
        "patrol_type": "back_and_forth",
        "speed": 0.9,
        "description": "Paces in the upper village",
    ...
    {
        "name": "Temple Priest",
        "spawn": (15, 15), # Inside the hollow center of the Temple (1s)
        "waypoints": [(12, 12), (17, 12), (17, 17), (12, 17)],
        "patrol_type": "circular",
        "speed": 0.8,
        "description": "Walks within the inner temple sanctum",
        "health": 40,  "exp": 20, "attack_damage": 5,
        "notice_radius": 150, "attack_radius": 50,
        "area_id": 1
    },
    {
        "name": "Dungeon Scout",
        "spawn": (5, 25), # Bottom-left
        "waypoints": [(2, 25), (8, 25)],
        "patrol_type": "back_and_forth",
        "speed": 1,
        "description": "Patrols the lower-left clearing",
    ...
    {
        "name": "Market Vendor",
        "spawn": (25, 25), # Bottom-right
        "waypoints": [(22, 25), (28, 25)],
        "patrol_type": "back_and_forth",
        "speed": 0.8,
        "description": "Lower village merchant",
        "health": 40,  "exp": 20, "attack_damage": 5,
        "notice_radius": 150, "attack_radius": 50,
        "area_id": 2
    },
    {
        ...
        "spawn": (15, 5), # Northern passage (Area 1)
        "waypoints": [],
        "patrol_type": "random",
        "speed": 1.2,
        "description": "Roams the northern passage",
...
class Enemy(pygame.sprite.Sprite):
    ...
    def load_sprites(self):
        ...
        from game_interaction.games.game_damien.code.game.sprite_loader import SpriteLoader
