...
from game_interaction.games.game_damien.code.game.item import Weapon
...
class Cleric(Character):
    ...
    def __init__(self, pos, groups, obstacle_sprites, player_id=None, is_local=True, test=False):
        ...
        if test:
            ...
            self.image = pygame.image.load(start_path + '/game_interaction/games/game_damien/graphics/characters/Cleric.png').convert_alpha()
        ...
        self.speed = 8
        self.healing = 5
        Staff = Weapon("Staff", "The staff allows the user to cast grand magic. It is also the starting weapon of a Druid.", start_path + "/game_interaction/games/game_damien/graphics/items/Staff.png", attack_bonus=2, value=40)
    ...
    def get_preview_image():
        ...
        return start_path + "/game_interaction/games/game_damien/graphics/characters/Cleric.png"
...
class Paladin(Character):
    ...
    def __init__(self, pos, groups, obstacle_sprites, player_id=None, is_local=True, test=False):
        ...
        if test:
            ...
            self.image = pygame.image.load(start_path + '/game_interaction/games/game_damien/graphics/characters/Paladin.png').convert_alpha()
        self.rect = self.image.get_rect(topleft=pos)
        self.hitbox = self.rect.inflate(0, -26)
        ...
        self.shield = False
        self.import_player_assets(animate=True)
        GreatSword = Weapon("GreatSword", "A large two handed sword that serves as the starter weapon for Barbarians and Paladins", start_path+ "/game_interaction/games/game_damien/graphics/item/GreatSword.png", attack_bonus=5, value=100)
    ...
    def get_preview_image():
        ...
        return start_path + "/game_interaction/games/game_damien/graphics/characters/Paladin.png"
...
class Barbarian(Character):
    ...
    def __init__(self, pos, groups, obstacle_sprites, player_id=None, is_local=True, test=False):
        ...
        if test:
            ...
            self.image = pygame.image.load(start_path + '/game_interaction/games/game_damien/graphics/characters/Barbarian.png').convert_alpha()
        self.rect = self.image.get_rect(topleft=pos)
        self.hitbox = self.rect.inflate(0, -26)
    ...
    def get_preview_image():
        ...
        return start_path + "/game_interaction/games/game_damien/graphics/characters/Barbarian.png"
...
class Sorcerer(Character):
    ...
    def __init__(self, pos, groups, obstacle_sprites, player_id=None, is_local=True, test=False):
        ...
        if test:
            ...
            self.image = pygame.image.load(start_path + '/game_interaction/games/game_damien/graphics/characters/Sorcerer.png').convert_alpha()
        self.rect = self.image.get_rect(topleft=pos)
        self.hitbox = self.rect.inflate(0, -26)
        ...
        self.spell_charge = 0
        self.import_player_assets(animate=True)
        Dagger = Weapon("Dagger", "A small one handed blade that does not do much damage. It is the starter weapon for sorcerers.", "/game_interaction/games/game_damien/graphics/item/Dagger.png", attack_bonus=2, value=30)
    ...
    def get_preview_image():
        ...
        return start_path + "/game_interaction/games/game_damien/graphics/characters/Sorcerer.png"
