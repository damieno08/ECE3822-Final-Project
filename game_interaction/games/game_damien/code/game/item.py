...
def create_example_items():
    ...
    items.append(Weapon(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/GreatSword.png",
        attack_bonus=5,
        value=100
    ))
    ...
    items.append(Weapon(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/Dagger.png",
        attack_bonus=2,
        value=30
    ))
    ...
    items.append(Armor(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/SpiderSilkShield.png",
        defense_bonus=1,
        value=20
    ))
    items.append(Armor(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/CloakMoonMaiden.png",
        defense_bonus=1,
        value=50
    ))
    ...
    items.append(Weapon(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/Longbow.png",
        attack_bonus=3,
        value=70
    ))
    ...
    items.append(Weapon(
        ...
        image_path=start_path + "game_interaction/games/game_damien/graphics/items/Staff.png",
        attack_bonus=2,
        value=40
    ))
    ...
    items.append(Consumable(
        ...
        image_path= start_path + "game_interaction/games/game_damien/graphics/items/MoonMaidenShard.png",
    ...
    items.append(QuestItem(
        ...
        image_path= start_path + "game_interaction/games/game_damien/graphics/items/SoulStrikeSword.png",
        quest_id="Mycanoid",
    ))
...
if __name__ == "__main__":
    ...
    sword = Weapon("Test Sword", "A test weapon", "game_interaction/games/game_damien/graphics/test.png", attack_bonus=5, value=50)
    print(f"Created: {sword}")
    print(f"Type: {sword.item_type}")
    print(f"Attack bonus: {sword.attack_bonus}\n")
    
    potion = Consumable("Test Potion", "Heals 20 HP", start_path + "game_interaction/games/game_damien/graphics/test.png", 
