...
from game_interaction.games.game_damien.code.game.ChatClient import ChatClient
...
class Level:
    def __init__(self, player_name, character_class, server_host='localhost', server_port=8080, serializer='text', chat_port=9090):
        ...
        self.network = NetworkClient("DamienGame", player_name, server_host, server_port, serializer)
