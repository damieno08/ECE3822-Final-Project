...
from game_interaction.games.game_damien.code.game.item import Item
import sys
...
if __name__ == "__main__":
    from game_interaction.games.game_damien.code.game.item import Weapon, Armor, Consumable
    ...
    # Add items
    print("Adding items...")
    GreatSword = Weapon("GreatSword", "A large two handed sword that serves as the starter weapon for Barbarians and Paladins", start_path + "/game_interaction/games/game_damien/graphics/items/GreatSword.png", attack_bonus=5, value=100)
    inventory.add_item(GreatSword)

    Dagger = Weapon("Dagger", "A small one handed blade that does not do much damage. It is the starter weapon for sorcerers.", start_path + "/game_interaction/games/game_damien/graphics/items/Dagger.png", attack_bonus=2, value=30)
    inventory.add_item(GreatSword)
